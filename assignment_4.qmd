...
Vi skal finne de NUTS3 sonene som inngår i «Average annual population to calculate regional GDP data (thousand persons) by NUTS 3 regions», men som ikke inngår i «Population on 1 January by broad age group, sex and NUTS 3 region».
...
Vi skal nå finne NUTS3 soner som inngår i «Population on 1 January by broad age group, sex and NUTS 3 region», men som ikke inngår i «Average annual population to calculate regional GDP data (thousand persons) by NUTS 3 regions».
...
Vi skal nå sjekke sonene i full_pop_nuts3 mot dem vi har i GDP tabellen.
